...
predictors <- c('AGE', 'MALE', 'HSGED', 'SOMEPOSTHS', 'POSTHSDEGREE', 'HISPANIC', 'USCITIZEN', 'CRIMINAL', 'CATEGORY2', 'CATEGORY3', 'CATEGORY4', 'CATEGORY5', 'CATEGORY6', 'NOCOUNTS', 'POINTS', 'TRIAL', 'YR2008','YR2007', 'YR2006', 'YR2005', 'YR2004', 'YR2003', 'YR2002', 'YR2001', 'YR2000', 'race') 
...
formula.full <- formula(
  ~ race + AGE + MALE + HSGED + SOMEPOSTHS + POSTHSDEGREE + HISPANIC + USCITIZEN + CRIMINAL + CATEGORY2 + CATEGORY3 + CATEGORY4 + CATEGORY5 + CATEGORY6 + NOCOUNTS + POINTS + TRIAL + YR2008 + YR2007 + YR2006 + YR2005 + YR2004 + YR2003 + YR2002 + YR2001 + YR2000
)

formula.full.race <- formula(
  ~ AGE + MALE + HSGED + SOMEPOSTHS + POSTHSDEGREE + HISPANIC + USCITIZEN + CRIMINAL + CATEGORY2 + CATEGORY3 + CATEGORY4 + CATEGORY5 + CATEGORY6 + NOCOUNTS + POINTS + TRIAL + YR2008 + YR2007 + YR2006 + YR2005 + YR2004 + YR2003 + YR2002 + YR2001 + YR2000
)
