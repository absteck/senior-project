...
sum(is.na(combine$SENTENCE) == FALSE) #525574. Hagen: 525509
...
combine$YR2000 <- ifelse(combine$YR == "2000", 1, 0) 
...
#percent some post high school: 15.03. Hagen: 15.17. INCONSISTENT 
mean(combine$SOMEPOSTHS, na.rm=TRUE)
table(combine$SOMEPOSTHS) #83587 post-HS. Hagen: 84,377. INCONSISTENT  
...
mean(combine$HISPANIC, na.rm = TRUE) #44.46. Hagen: 40.07. INCONSISTENT
table(combine$HISPANIC) #247965, consistent with Hagen. But I created more NAs instead of lumping everything into "Other"

mean(combine$USCITIZEN, na.rm=TRUE) #63.63. Hagen: 60.79

#Hagen num obs: 618825, 
mean(combine$CRIMINAL, na.rm=TRUE) #72.26. Hagen: 70.23. INCONSISTENT 
table(combine$CRIMINAL) #394,149, Hagen: 434,616. INCONSISTENT 
