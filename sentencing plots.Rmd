...
#WHOA THE ABOVE BIAS-CORRECTED ATES ARE WAY TOO BIG 
```
...
## plot bounds ##
#################
#NO ATE IS SHOWING UP FOR thresh = 1
...
#DOES IT MAKE SENSE THAT ATT > ATE FOR LOWER-LEVEL CONVICTIONS? IN THAT THOSE ARE THE CRIMES WHERE POCS WOULDN'T HAVE BEEN CONVICTED AT ALL IF THEY WERE WHITE, WHILE WHITE PEOPLE WHO GET CONVICTED HAVE TO DO SOMETHING VERY DISTASTEFUL? 

#EXPLORING VALUES OF min.cilo and max.cihi
min(results[results$thresh >= thresh & results$qoi == 'ates',"min.cilo"])
max(results[results$thresh >= thresh & results$qoi == 'ates',"min.cilo"])*nrow(df)/1000

#SHOULD THIS BE results$thresh >= thresh SO AS TO INCLUDE ALL OBSERVATIONS? 
...
#results[1:100, ] #compared to KLM, there's a more dramatic difference between CI when rho = 0 and when rho = 0.99. IS THE WONKY GRAPH DUE TO A SCALING ISSUE? 
