...
\[
\begin{align*}
\Delta = E[Y_i|D_i = 1, M_i(1) = 1, M_i(0) = 1] P(M_i(0) = 1 | M_i(1) = 1, D_i = 1) + E[Y_i|D_i = 1, M_i(1) = 1, M_i(0) = 0] P(M_i(0) = 0 | M_i(1) = 1, D_i = 1) - E[Y_i|D_i = 0, M_i(0) = 0, M_i(1) = 1] P(M_i(1) = 1 | M_i(0) = 0, D_i = 0) - E[Y_i|D_i = 0, M_i(0) = 0, M_i(1) = 0] P(M_i(1) = 0 | M_i(0) = 0, D_i = 0)
\end{align*}
\]
...
results[1:100, ] 
#my results for threshold 1 are off - the lower and upper bounds are identical 
#lower and upper bounds begin to differ at threshold 2. WHAT'S UP WITH THRESH = 1? 
```
