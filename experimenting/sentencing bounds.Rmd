...
mods.base.correct 
#QUESTION: Shouldn't standard errors increase with decreasing sample size (ie higher threshold), in which case thresh = 15 would have the smallest standard errors?  
...
#using the fake covariate vector of mean covariate values, I computed the probability of a black person receiving an above-third-quartile sentence for assault. 
