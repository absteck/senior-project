...
sentence.quartiles <- c(
  ...
  'above 0.03' #TEMPORARY: delete after resolving question about standard error
)
...
(p.white.q2 <- log.odds.to.prob(mods.base.correct[[2]]$mod$coefficients[1], mods.base.correct[[2]]$mod$coefficients[2], 0))
#probability that a black person receives an above-median sentence 
(p.black.q2 <- log.odds.to.prob(mods.base.correct[[2]]$mod$coefficients[1], mods.base.correct[[2]]$mod$coefficients[2], 1))

#probability that a white person receives an above-first-quartile sentence 
(p.white.q1 <- log.odds.to.prob(mods.base.correct[[3]]$mod$coefficients[1], mods.base.correct[[3]]$mod$coefficients[2], 0))
#probability that a black person receives an above-first-quartile sentence 
(p.black.q1 <- log.odds.to.prob(mods.base.correct[[3]]$mod$coefficients[1], mods.base.correct[[3]]$mod$coefficients[2], 1))
...
dim(results) # number of values of rho x number of sentence thresholds x 2 estimands x number of model specifications
