...
*I am using this file to investigate how my confidence intervals change when I cluster on primary offense level, holding all else equal with "sentencing bounds.Rmd."*
...
if (!file.exists('mods_base_correct_blackwhite_sentencing_clustered.rds')){
  ...
  saveRDS(mods.base.correct, 'mods_base_correct_blackwhite_sentencing_clustered.rds')
} else {
  mods.base.correct <- readRDS('mods_base_correct_blackwhite_sentencing_clustered.rds')
}
...
results.fname <- sprintf(
  'bounds_results_n%s_alpha%s_blackwhite_sentencing_clustered.rds',
  ndraws,
  alpha * 100
) 
